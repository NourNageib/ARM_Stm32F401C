...
class RPCServer:
    ...
    '''
        registerInstance: pass an instance of a class to register all its methods and attributes so they can be used by the client via rpcs
            Arguments:
            instance -> a class object
    '''
    ...
    '''
        handle: pass client connection and its address to perform requests between client and server (recorded functions or) 
        Arguments:
        client -> 
    '''
